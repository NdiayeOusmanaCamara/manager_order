    ...
    <div class="container mt-4">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <!-- gjjbj -->
           <router-link :to="{ name: 'order-view', params: { id: order.trackNumber } }"> <i class="fas fa-eye text-info" style="cursor: pointer; margin-right: 8px;" ></i>
           </router-link>
           <router-link :to="{ name: 'order-edit', params: { id: order.trackNumber } }">  <i class="fas fa-edit text-warning" style="cursor: pointer; margin-right: 8px;" ></i>
           </router-link>
